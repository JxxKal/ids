...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  { version: 'v2.5.0', date: '2026-05-10', title: 'Pattern-Federation + RedTeam-Tooling (Minor)', notes: [] },
  ...
  { version: 'v2.4.0', date: '2026-05-07', title: 'Major-Bump — Container-Ops + Tap-Update-Mechanik', notes: [] },
  ...
  { version: 'v1.0.35', date: '2026-04-25', title: 'Kernel-Console-Spam blockiert Wizard und Login auf lokaler tty1', notes: [] },
  { version: 'v1.0.34', date: '2026-04-25', title: 'Passwort-Schritt für ids/root bleibt mit blinkendem Cursor stehen', notes: [] },
  { version: 'v1.0.33', date: '2026-04-25', title: 'ISO-Release-Notes auf aktuellen Wizard-Stand bringen', notes: [] },
  { version: 'v1.0.32', date: '2026-04-25', title: 'Bootsplash mit CYJAN-Schild-Logo statt Default-PNG', notes: [] },
  { version: 'v1.0.31', date: '2026-04-25', title: 'Boot-Menü vereinheitlicht, Splash zurück, NOPASSWD für Installer', notes: [] },
  { version: 'v1.0.30', date: '2026-04-25', title: 'URL-sichere Secrets, Admin-Login funktional, ids/root-Passwörter im Wizard', notes: [] },
  { version: 'v1.0.29', date: '2026-04-25', title: 'Mirror-Iface-Auswahl, Build-Fortschritt pro Service, Versionsheader', notes: [] },
  { version: 'v1.0.28', date: '2026-04-25', title: 'Setup-Wizard zeigt Build-Fehler + robusterer Auto-Start', notes: [] },
  { version: 'v1.0.27', date: '2026-04-25', title: 'Installer hängt bei 70% – Variablen-Scope', notes: [] },
  { version: 'v1.0.26', date: '2026-04-25', title: 'Live-ISO als Installer, dann Setup auf echter Disk', notes: [] },
  { version: 'v1.0.25', date: '2026-04-25', title: '.env-Variablennamen an docker-compose.yml angleichen', notes: [] },
  { version: 'v1.0.24', date: '2026-04-25', title: 'First-Boot-Wizard crashed beim ersten Passwort', notes: [] },
  { version: 'v1.0.23', date: '2026-04-25', title: 'autologin-Drop-In nach live-config laden + Tags im CI holen', notes: [] },
  { version: 'v1.0.22', date: '2026-04-25', title: 'Version-Tag in ISO + Boot-Status auf TTY1 + SSH-Hardening', notes: [] },
  { version: 'v1.0.21', date: '2026-04-25', title: 'SSH-Server installieren + ids-banner ohne clear', notes: [] },
  { version: 'v1.0.20', date: '2026-04-24', title: 'initrd-Pfad korrigiert – heißt /live/initrd.img, nicht /live/initrd', notes: [] },
  { version: 'v1.0.19', date: '2026-04-24', title: 'Bootloader bare-bones – Text-Mode + live-theme entfernen', notes: [] },
  { version: 'v1.0.18', date: '2026-04-24', title: 'Bootloader-Hook läuft endlich – Pfade waren doppelt relativ', notes: [] },
  ...
  { version: 'v1.0.15', date: '2026-04-24', title: 'Bootmenü sichtbar halten – self-contained Configs', notes: [] },
  { version: 'v1.0.14', date: '2026-04-24', title: 'Bootsplash, Menü und TTY-Stabilität', notes: [] },
  { version: 'v1.0.13', date: '2026-04-24', title: 'Badge + Drawer für unbekannte Hosts im Dashboard-Header', notes: [] },
  { version: 'v1.0.12', date: '2026-04-24', title: 'Version auf v1.0.12 erhöhen', notes: [] },
  { version: 'v1.0.11', date: '2026-04-24', title: 'Version auf v1.0.11 erhöhen', notes: [] },
  { version: 'v1.0.10', date: '2026-04-24', title: 'bump version to v1.0.10', notes: [] },
  ...
  { version: 'v1.0.2', date: '2026-04-20', title: 'ISO-Boot repariert und Festplatten-Installer hinzugefügt', notes: [] },
];
